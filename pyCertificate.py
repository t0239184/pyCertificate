...
def create_self_signed_root_ca_certificate(root_ca_info, sign_method="sha256", days=3650):
...
if __name__ == '__main__':
    ...
    root_ca_cert, root_ca_private_key = create_self_signed_root_ca_certificate(root_ca_info)
